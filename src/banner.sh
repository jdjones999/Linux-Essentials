#!/bin/bash
printf '\n%.s' {1..29} #Adds number of blank rows
echo -e "\033[H"  # Move cursor to the beginning of the previous line
#clear
echo "SolarOS 4.0.1 Generic_50203-2 sun4m i386 Unknown.Unknown"
echo ":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::" | lolcat
echo ""
#figlet -f rowancap NeoConn | lolcat
figlet -f rowancap NeoConn | sed 's/.*/\o033[38;5;208m&\o033[0m/'
echo ":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::" | lolcat
