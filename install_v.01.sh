...
NC='\033[0m' # No Color
#===============================[ Install form requirements.conf ]===============================
# Check if requirements.conf file exists
if [ -f "requirements.conf" ]; then
    display_section_header "$BLUE" "Installing packages from requirements.conf:"

    # Read each line in requirements.conf and install the packages
    ...
    display_section_header "$RED" "Error: requirements.conf file not found."
fi
#===============================[ Install (search) ]===============================
